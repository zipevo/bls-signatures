...
prepare() {
    download_gmp() {
        ...
        GMP_DIR="${CURRENT_DIR}/${BUILD}/contrib/gmp"
...
#--disable-shared --enable-static --host="${HOST}" --disable-assembly \
